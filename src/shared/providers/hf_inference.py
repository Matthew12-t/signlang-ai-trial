...
Speech lives here rather than in ``huggingface.py`` because that module holds the
chat adapter Gloss and Recall share; the two families have no code in common.
...
class _HfApiProvider:
    ...
    def _build_client(self) -> Any:
        ...
        return AsyncInferenceClient(
            provider=self._settings.hf_provider,
